...
<div class="sai">
	<ul style="position:relative" class="su">
...
.he{position: absolute;top:0.39rem;left:0;clear: both;width:100%;}
...
.sai .su{height:0.35rem;border-bottom:1px solid #999;display: flex;width:100%;background:#fff;}
...
.sx ul li{width:100%;padding-left:0.2rem;display: flex;justify-content: flex-start;height:0.3rem;border-bottom:1px solid #999;}
